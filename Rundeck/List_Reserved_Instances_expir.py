...
spreadsheet = client.open("List_Reserved_Instances_expir")
...
path_to_file = '/tmp/reserved_instances_inventory/List_Reserved_Instances_expir.csv'
path = Path(path_to_file)

if path.is_file():
    ImportCsv("/tmp/reserved_instances_inventory/List_Reserved_Instances_expir.csv", spreadsheet, curr_sheet)
else:
    print("There are no expired reserved instances for now.")
